...
This module provides an LRU (Least Recently Used) caching class that extends
the BaseCaching class.
The LRUCache class implements a caching strategy where the least recently
...
Classes:
    - LRUCache: Implements LRU caching strategy with put and get methods.
"""
...
class LRUCache(BaseCaching):
    """
    LRUCache: A cache that implements an LRU (Least Recently Used)
    eviction policy.

    Inherits from BaseCaching and overrides the put and get methods to
    implement LRU caching. The least recently used item is removed
    ...
    def put(self, key: Any, item: Any) -> None:
        ...
        is full, it discards the least recently used item.
